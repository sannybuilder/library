...
export const GameClassesAssets: Partial<Record<Game, string>> = {
  ...
  [Game.gta3_ps2]: 'assets/gta3_ps2/classes.db',
...
export const GameEnumsAssets: Partial<Record<Game, string>> = {
  ...
  [Game.gta3_ps2]: 'assets/gta3_ps2/enums.txt',
...
export const GameOpcodesTxtAssets: Partial<Record<Game, string>> = {
  ...
  [Game.gta3_ps2]: 'assets/gta3_ps2/opcodes.txt',
...
export const GameSnippets: Record<Game, string> = {
  ...
  [Game.gta3_ps2]: 'gta3/snippets.json',
...
export const GamePlatforms: Record<Game, Platform[]> = {
  ...r(() => [Platform.PC]),
  [Game.gta3_ps2]: [Platform.Console],
...
export enum ViewMode {
  ...
  ViewEnum = 'ViewEnum',
  EditEnum = 'EditEnum',
  ViewScmRefs = 'ViewScmRefs',
  EditScmRefs = 'EditScmRefs',
  ViewScmVariables = 'ViewScmVariables',
  EditScmVariables = 'EditScmVariables',
...
export type SyntaxKind = 'sb_command' | 'sb_class' | 'cleo_redux' | 'sb_function';
...
export const GameSourceRepo: Partial<Record<Game, string>> = {
  ...
  [Game.gta3_ps2]: 'sannybuilder/GTA_III_SCRIPT',
