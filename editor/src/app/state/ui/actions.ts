...
export const generateNewJson = createAction('[ui] generate new json');

export const updateJsonModel = createAction(
  '[ui] update json model',
  props<{ model: JsonModel }>(),
);
...
export const toggleSnippetOnlySearch = createAction(
  '[ui] toggle snippet only search',
);

export const toggleFunctionDeclaration = createAction(
  '[ui] toggle function declaration',
);
...
export const setEditorHasError = createAction(
